<x-app-layout>
    ...
    <h2 class="text-2xl m-2 bg-white">Halaman Data Barang Tersedia</h2>
              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Jumlah Produk Tersedia</th>
