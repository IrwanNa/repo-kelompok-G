<x-app-layout>
    ...
    <h2 class="text-2xl m-2">Halaman Input Barang Terjual</h2>

<form method="post" action="{{ route('barangKeluar.store') }}" class="m-5 p-5">
    @csrf
    @method('post')
    <div class="mb-4">
    ...
    <div class="flex items-center justify-between">
        <button type="submit" class="py-3 text-white px-4 inline-flex items-center gap-x-2 text-sm font-semibold  bg-green-600  hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
            Simpan
          </button>
    </div>
</form>
