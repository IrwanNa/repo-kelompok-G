<x-app-layout>
    ...
    <h2 class="text-2xl m-2 bg-white">Halaman Data Barang Habis</h2>
              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Nama Produk Habis</th>
                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Jumlah Produk yang Dibutuhkan</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Popmie</td>
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Le Mienaral</td>
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Energen</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">25</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">minuman</td>
                  </tr>
                </tbody>
